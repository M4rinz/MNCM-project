...
\section{Stimatori per \texorpdfstring{$P$}{P}}
	...
	\begin{frame}
		...
		\end{align*}
		si ha $\hat{P}_{\textup{CLS}}=\hat{\Lambda}_t\hat{\Lambda}_{t,t+1}$.}
		\smallskip
		...
		\onslide<4->{Dunque $\hat{P}_{\textup{CLS}}=\hat{\Lambda}_t\hat{\Lambda}_{t,t+1}$ 
	...
	\begin{frame}
		...
		Si ha $\mathbb{E}\qty[\vb*{y}_t\transpose{\vb*{y}_t}]=\mathbb{E}\qty[\vb*{n}_t\transpose{\vb*{n}_t}]+\Var{\epsilon_t}$,
		e $\mathbb{E}\qty[\vb*{y}_t\transpose{\vb*{y}_{t+1}}]=\mathbb{E}\qty[\vb*{n}_t\transpose{\vb*{n}_{t+1}}]$.
		\smallskip

		Dunque con osservazioni rumorose
		\[
			\hat{P}_{\textup{CLS}}=\qty(\hat{\Lambda}_t+V)^{-1}\Lambda_{t,t+1}\xcancel{\overset{T\to\infty}{\longrightarrow}P}
		\]
		ossia $\hat{P}_{\textup{CLS}}$ non è consistente con osservazioni rumorose.

		Il prossimo stimatore sarà consistente anche con osservazioni rumorose.
	\end{frame}
...
\section*{Appendice}
	...
	\begin{frame}
		{\hypertarget{frame:dim_prop_2:appendice}{Dimostrazione $P=\Lambda_t^{-1}\Lambda_{t,t+1}\qquad 2/2$}}
