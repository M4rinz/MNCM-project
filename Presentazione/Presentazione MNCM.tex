...
\section{Stimatori per \texorpdfstring{$P$}{P}}
	...
	\begin{frame}
		...
		\[
			\hat{P}_{\textup{CLS}}=\qty(\hat{\Lambda}_t+V)^{-1}\hat{\Lambda}_{t,t+1}\xcancel{\xrightarrow{T\to\infty}P}
		\]
...
\section*{Appendice}
	...
	\begin{frame}
		...
		In particolare $P_{i,j}\xrightarrow{n\to\infty}\pi_j\quad\forall\,i,j\in[S]$.}
